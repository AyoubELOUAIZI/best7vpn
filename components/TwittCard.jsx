...
const TwittCard = () => {
  return (
    ...
    <div class="flex items-center"><img alt='profile' src="https://pbs.twimg.com/profile_images/1488434260860182529/uCD5L1hQ_400x400.jpg" class="h-12 w-12 rounded-full"/>
