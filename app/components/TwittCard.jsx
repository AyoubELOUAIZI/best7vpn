...
const TwittCard = () => {
  return (
    ...
    <div className="flex items-center"><img alt='profile' src="https://pbs.twimg.com/profile_images/1488434260860182529/uCD5L1hQ_400x400.jpg" className="h-12 w-12 rounded-full"/>
        <div className="flex flex-col ml-4"><a className="font-bold text-black" href="#">Emily Jane
                Morgan</a><span className="text-grey">@MorganEmilyJane</span></div><svg viewBox="328 355 335 276"
    ...
    <div className=" mt-3 mb-1 leading-normal text-lg">It’s a pretty gnarly afternoon session, compared to this morning.
    ...
    <div className="flex text-grey">
        <div className="flex items-center mr-4"><svg className="mr-2" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div className="flex items-center"><svg className="mr-2" width="24" height="24" viewBox="0 0 24 24">
                <path className="fill-current"
