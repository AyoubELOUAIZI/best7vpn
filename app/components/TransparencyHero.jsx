...
const TransparencyHero = () => {
  return (
    <div class="max-w-7xl mt-6 mx-auto rounded-3xl pb-20 text-center">
      <div class="relative m-auto max-w-xl">
        ...
        <a href="#" target="_blank">
          <h2 class="mt-4 font-dm-sans text-mobile-h3 font-semibold leading-snug sm:text-mobile-h2 md:text-desktop-h2">
            Transparent VPN Insights
          </h2>
        </a>
        <p class="mt-4 font-dm-sans text-desktop-paragraph text-slate-body">
          Discover unbiased VPN reviews at best7vpn.online. We believe in
          transparency. Our honest recommendations empower your digital privacy.
          Support us through affiliate links—your choice, zero extra cost. Trust
          us for reliable VPN insights. Your privacy, our priority.
        </p>
        <svg
          class="absolute top-24 -left-10 hidden h-36 fill-current text-slate-body sm:block md:-left-14 md:h-44"
          viewBox="0 0 644 947"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        <svg
          class="absolute top-24 -right-10 hidden h-36 fill-current text-slate-body sm:block md:-right-14 md:h-44"
          viewBox="0 0 644 947"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
