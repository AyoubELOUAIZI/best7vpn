...
const ReversHero = () => {
  return (
	...
	<div class="container items-center flex flex-col justify-center mx-auto sm:py-12 lg:px-32 lg:flex-row lg:justify-around">
		...
		<div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg ">
